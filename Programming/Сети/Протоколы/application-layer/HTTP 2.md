...
- **Мультиплексирование**: Позволяет нескольким запросам и ответам передаваться по одному [[TCP]]-соединению одновременно, что уменьшает время загрузки страниц и увеличивает пропускную способность.
